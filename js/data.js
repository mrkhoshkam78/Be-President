...
const PLAYABLE_COUNTRIES = [
  ...
  },
  {
    ...
    color: '#f59e0b',
    region: 'اروپا',
    description: 'قدرت تجاری و بندری اروپا.',
    population: 18000000,
    baseGDP: 133,
    baseBudget: 42,
    debt: 55,
    ...
    stability: 82,
    infrastructure: 88,
    industrialProduction: 80,
    naturalResources: 55,
    resources: { oil: 40, gas: 70, minerals: 25, agriculture: 50, rare_earth: 17 },
    military: { army: 43, airForce: 37, navy: 30, defenseSystems: 40, tech: 88, readiness: 47 },
    techLevel: 88,
    intelLevel: 62,
    strengths: ['بندر روتردام','کشاورزی','فناوری'],
    weaknesses: ['وابستگی تجارت خارجی'],
    economyPower: 78, militaryPower: 55,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    id: 'switzerland',
    name: 'سوئیس',
    ...
    color: '#ef4444',
    region: 'اروپا',
    description: 'اقتصاد باثبات و نوآوری.',
    population: 9000000,
    baseGDP: 104,
    baseBudget: 35,
    debt: 28,
    ...
    stability: 92,
    infrastructure: 90,
    industrialProduction: 82,
    naturalResources: 25,
    resources: { oil: 20, gas: 25, minerals: 20, agriculture: 70, rare_earth: 18 },
    military: { army: 33, airForce: 27, navy: 20, defenseSystems: 30, tech: 92, readiness: 40 },
    techLevel: 92,
    intelLevel: 70,
    strengths: ['بی‌طرفی','فناوری','بانکداری'],
    weaknesses: ['بازار کوچک'],
    economyPower: 90, militaryPower: 45,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    stability: 70,
    infrastructure: 72,
    industrialProduction: 64,
    naturalResources: 37,
    resources: { oil: 35, gas: 40, minerals: 20, agriculture: 55, rare_earth: 12 },
    military: { army: 46, airForce: 40, navy: 33, defenseSystems: 43, tech: 62, readiness: 50 },
    techLevel: 62,
    intelLevel: 52,
    strengths: ['صنعت','موقعیت ژئوپلیتیک'],
    weaknesses: ['وابستگی انرژی'],
    economyPower: 62, militaryPower: 58,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    color: '#3b82f6',
    region: 'اروپا',
    description: 'دولت رفاه و نوآوری سبز.',
    population: 10500000,
    baseGDP: 67,
    baseBudget: 22,
    debt: 35,
    ...
    industrialProduction: 82,
    naturalResources: 27,
    resources: { oil: 25, gas: 30, minerals: 20, agriculture: 65, rare_earth: 17 },
    military: { army: 38, airForce: 32, navy: 25, defenseSystems: 35, tech: 88, readiness: 42 },
    techLevel: 88,
    intelLevel: 65,
    strengths: ['فناوری سبز','آموزش'],
    weaknesses: ['هزینه نیروی کار'],
    economyPower: 82, militaryPower: 50,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    color: '#fbbf24',
    region: 'اروپا',
    description: 'مرکز اتحادیه اروپا.',
    population: 11700000,
    baseGDP: 72,
    baseBudget: 25,
    debt: 48,
    ...
    stability: 82,
    infrastructure: 84,
    industrialProduction: 76,
    naturalResources: 32,
    resources: { oil: 30, gas: 35, minerals: 20, agriculture: 60, rare_earth: 16 },
    military: { army: 36, airForce: 30, navy: 23, defenseSystems: 33, tech: 80, readiness: 40 },
    techLevel: 80,
    intelLevel: 58,
    strengths: ['لجستیک','نهادها'],
    weaknesses: ['تقسیمات زبانی'],
    economyPower: 75, militaryPower: 48,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    stability: 90,
    infrastructure: 92,
    industrialProduction: 84,
    naturalResources: 82,
    resources: { oil: 80, gas: 85, minerals: 65, agriculture: 30, rare_earth: 17 },
    military: { army: 43, airForce: 37, navy: 30, defenseSystems: 40, tech: 85, readiness: 47 },
    techLevel: 85,
    intelLevel: 60,
    strengths: ['نفت و گاز','صندوق ثروت'],
    weaknesses: ['وابستگی هیدروکربن'],
    economyPower: 88, militaryPower: 55,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    color: '#dc2626',
    region: 'اروپا',
    description: 'اقتصاد آلپی پایدار.',
    population: 9100000,
    baseGDP: 58,
    baseBudget: 18,
    debt: 38,
    ...
    naturalResources: 27,
    resources: { oil: 25, gas: 30, minerals: 20, agriculture: 65, rare_earth: 16 },
    military: { army: 36, airForce: 30, navy: 23, defenseSystems: 33, tech: 82, readiness: 40 },
    techLevel: 82,
    intelLevel: 55,
    strengths: ['گردشگری','صنعت'],
    weaknesses: ['بازار کوچک'],
    economyPower: 78, militaryPower: 48,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    industrialProduction: 77,
    naturalResources: 25,
    resources: { oil: 20, gas: 20, minerals: 20, agriculture: 70, rare_earth: 17 },
    military: { army: 30, airForce: 24, navy: 17, defenseSystems: 27, tech: 88, readiness: 40 },
    techLevel: 88,
    intelLevel: 55,
    strengths: ['فناوری','FDI'],
    weaknesses: ['حباب مسکن'],
    economyPower: 85, militaryPower: 42,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    industrialProduction: 64,
    naturalResources: 25,
    resources: { oil: 20, gas: 25, minerals: 20, agriculture: 70, rare_earth: 13 },
    military: { army: 33, airForce: 27, navy: 20, defenseSystems: 30, tech: 65, readiness: 40 },
    techLevel: 65,
    intelLevel: 48,
    strengths: ['گردشگری','انرژی تجدیدپذیر'],
    weaknesses: ['بدهی'],
    economyPower: 58, militaryPower: 45,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    color: '#3b82f6',
    region: 'اروپا',
    description: 'گردشگری با چالش بدهی.',
    population: 10400000,
    baseGDP: 28,
    baseBudget: 10,
    debt: 70,
    ...
    industrialProduction: 60,
    naturalResources: 25,
    resources: { oil: 15, gas: 20, minerals: 20, agriculture: 75, rare_earth: 12 },
    military: { army: 43, airForce: 37, navy: 30, defenseSystems: 40, tech: 60, readiness: 47 },
    techLevel: 60,
    intelLevel: 50,
    strengths: ['گردشگری','کشتیرانی'],
    weaknesses: ['بدهی','بیکاری'],
    economyPower: 52, militaryPower: 55,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    industrialProduction: 72,
    naturalResources: 32,
    resources: { oil: 30, gas: 35, minerals: 20, agriculture: 60, rare_earth: 14 },
    military: { army: 38, airForce: 32, navy: 25, defenseSystems: 35, tech: 72, readiness: 42 },
    techLevel: 72,
    intelLevel: 55,
    strengths: ['خودرو','مهندسی'],
    weaknesses: ['وابستگی آلمان'],
    economyPower: 68, militaryPower: 50,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    color: '#fbbf24',
    region: 'اروپا',
    description: 'همگرایی با اتحادیه اروپا.',
    population: 19000000,
    baseGDP: 38,
    baseBudget: 12,
    debt: 45,
    ...
    stability: 60,
    infrastructure: 62,
    industrialProduction: 54,
    naturalResources: 37,
    resources: { oil: 35, gas: 40, minerals: 20, agriculture: 55, rare_earth: 11 },
    military: { army: 36, airForce: 30, navy: 23, defenseSystems: 33, tech: 55, readiness: 40 },
    techLevel: 55,
    intelLevel: 48,
    strengths: ['IT','کشاورزی'],
    weaknesses: ['فساد','مهاجرت'],
    economyPower: 52, militaryPower: 48,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    industrialProduction: 80,
    naturalResources: 87,
    resources: { oil: 85, gas: 90, minerals: 70, agriculture: 30, rare_earth: 15 },
    military: { army: 58, airForce: 52, navy: 45, defenseSystems: 55, tech: 75, readiness: 62 },
    techLevel: 75,
    intelLevel: 68,
    strengths: ['نفت','مالی','گردشگری'],
    weaknesses: ['وابستگی نفت'],
    economyPower: 80, militaryPower: 70,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    color: '#3b82f6',
    region: 'خاورمیانه',
    description: 'قدرت فناوری و نظامی.',
    population: 9800000,
    baseGDP: 61,
    baseBudget: 20,
    debt: 42,
    ...
    industrialProduction: 77,
    naturalResources: 25,
    resources: { oil: 20, gas: 25, minerals: 20, agriculture: 70, rare_earth: 19 },
    military: { army: 73, airForce: 67, navy: 60, defenseSystems: 70, tech: 95, readiness: 77 },
    techLevel: 95,
    intelLevel: 88,
    strengths: ['فناوری','نوآوری','نظامی'],
    weaknesses: ['تنش امنیتی'],
    economyPower: 85, militaryPower: 85,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    industrialProduction: 42,
    naturalResources: 77,
    resources: { oil: 75, gas: 80, minerals: 60, agriculture: 30, rare_earth: 11 },
    military: { army: 60, airForce: 54, navy: 47, defenseSystems: 57, tech: 55, readiness: 64 },
    techLevel: 55,
    intelLevel: 65,
    strengths: ['نفت و گاز','معادن'],
    weaknesses: ['تحریم','تورم'],
  ...
  },
  {
    ...
    stability: 35,
    infrastructure: 40,
    industrialProduction: 32,
    naturalResources: 77,
    resources: { oil: 80, gas: 75, minerals: 65, agriculture: 30, rare_earth: 8 },
    military: { army: 33, airForce: 27, navy: 20, defenseSystems: 30, tech: 40, readiness: 40 },
    techLevel: 40,
    intelLevel: 50,
    strengths: ['نفت'],
    weaknesses: ['فساد','امنیت'],
    economyPower: 35, militaryPower: 45,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    industrialProduction: 82,
    naturalResources: 82,
    resources: { oil: 70, gas: 95, minerals: 55, agriculture: 30, rare_earth: 14 },
    military: { army: 43, airForce: 37, navy: 30, defenseSystems: 40, tech: 70, readiness: 47 },
    techLevel: 70,
    intelLevel: 65,
    strengths: ['گاز','سرمایه‌گذاری'],
    weaknesses: ['بازار کوچک'],
    economyPower: 82, militaryPower: 55,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    stability: 80,
    infrastructure: 82,
    industrialProduction: 74,
    naturalResources: 87,
    resources: { oil: 85, gas: 90, minerals: 70, agriculture: 30, rare_earth: 13 },
    military: { army: 38, airForce: 32, navy: 25, defenseSystems: 35, tech: 65, readiness: 42 },
    techLevel: 65,
    intelLevel: 55,
    strengths: ['نفت'],
    weaknesses: ['وابستگی نفت'],
    economyPower: 75, militaryPower: 50,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    industrialProduction: 64,
    naturalResources: 42,
    resources: { oil: 40, gas: 45, minerals: 25, agriculture: 50, rare_earth: 11 },
    military: { army: 36, airForce: 30, navy: 23, defenseSystems: 33, tech: 55, readiness: 40 },
    techLevel: 55,
    intelLevel: 50,
    strengths: ['گردشگری','خودرو'],
    weaknesses: ['بی‌ثباتی سیاسی'],
    economyPower: 58, militaryPower: 48,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    naturalResources: 37,
    resources: { oil: 35, gas: 40, minerals: 20, agriculture: 55, rare_earth: 11 },
    military: { army: 38, airForce: 32, navy: 25, defenseSystems: 35, tech: 55, readiness: 42 },
    techLevel: 55,
    intelLevel: 48,
    strengths: ['تولید','صادرات'],
    weaknesses: ['زیرساخت'],
    economyPower: 55, militaryPower: 50,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    stability: 72,
    infrastructure: 75,
    industrialProduction: 67,
    naturalResources: 55,
    resources: { oil: 55, gas: 55, minerals: 40, agriculture: 35, rare_earth: 12 },
    military: { army: 40, airForce: 34, navy: 27, defenseSystems: 37, tech: 60, readiness: 44 },
    techLevel: 60,
    intelLevel: 52,
    strengths: ['نفت','الکترونیک'],
    weaknesses: ['تقسیمات قومی'],
    economyPower: 62, militaryPower: 52,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    industrialProduction: 50,
    naturalResources: 32,
    resources: { oil: 30, gas: 35, minerals: 20, agriculture: 60, rare_earth: 10 },
    military: { army: 30, airForce: 24, navy: 17, defenseSystems: 27, tech: 50, readiness: 40 },
    techLevel: 50,
    intelLevel: 45,
    strengths: ['BPO','حواله'],
    weaknesses: ['فقر','بلایا'],
    economyPower: 48, militaryPower: 42,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    stability: 95,
    infrastructure: 95,
    industrialProduction: 87,
    naturalResources: 25,
    resources: { oil: 10, gas: 15, minerals: 20, agriculture: 80, rare_earth: 18 },
    military: { army: 43, airForce: 37, navy: 30, defenseSystems: 40, tech: 92, readiness: 47 },
    techLevel: 92,
    intelLevel: 75,
    strengths: ['مالی','بندر','فناوری'],
    weaknesses: ['فضای محدود'],
    economyPower: 95, militaryPower: 55,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    stability: 42,
    infrastructure: 48,
    industrialProduction: 40,
    naturalResources: 32,
    resources: { oil: 30, gas: 35, minerals: 20, agriculture: 60, rare_earth: 9 },
    military: { army: 46, airForce: 40, navy: 33, defenseSystems: 43, tech: 48, readiness: 50 },
    techLevel: 48,
    intelLevel: 55,
    strengths: ['کشاورزی','نیروی کار'],
    weaknesses: ['بدهی','انرژی'],
    economyPower: 40, militaryPower: 58,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    stability: 50,
    infrastructure: 55,
    industrialProduction: 47,
    naturalResources: 25,
    resources: { oil: 20, gas: 25, minerals: 20, agriculture: 70, rare_earth: 9 },
    military: { army: 28, airForce: 22, navy: 15, defenseSystems: 25, tech: 45, readiness: 40 },
    techLevel: 45,
    intelLevel: 40,
    strengths: ['پوشاک','حواله'],
    weaknesses: ['زیرساخت'],
    economyPower: 45, militaryPower: 40,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    industrialProduction: 82,
    naturalResources: 25,
    resources: { oil: 15, gas: 20, minerals: 20, agriculture: 75, rare_earth: 18 },
    military: { army: 53, airForce: 47, navy: 40, defenseSystems: 50, tech: 92, readiness: 57 },
    techLevel: 92,
    intelLevel: 70,
    strengths: ['نیمه‌هادی','فناوری'],
    weaknesses: ['تنش ژئوپلیتیک'],
    economyPower: 88, militaryPower: 65,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    stability: 55,
    infrastructure: 60,
    industrialProduction: 52,
    naturalResources: 67,
    resources: { oil: 70, gas: 65, minerals: 55, agriculture: 30, rare_earth: 10 },
    military: { army: 36, airForce: 30, navy: 23, defenseSystems: 33, tech: 50, readiness: 40 },
    techLevel: 50,
    intelLevel: 48,
    strengths: ['نفت','اورانیوم'],
    weaknesses: ['فساد'],
    economyPower: 52, militaryPower: 48,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    industrialProduction: 52,
    naturalResources: 52,
    resources: { oil: 55, gas: 50, minerals: 40, agriculture: 35, rare_earth: 11 },
    military: { army: 36, airForce: 30, navy: 23, defenseSystems: 33, tech: 55, readiness: 40 },
    techLevel: 55,
    intelLevel: 48,
    strengths: ['کشاورزی','لیتیم'],
    weaknesses: ['تورم مزمن'],
    economyPower: 55, militaryPower: 48,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    industrialProduction: 50,
    naturalResources: 47,
    resources: { oil: 50, gas: 45, minerals: 35, agriculture: 40, rare_earth: 10 },
    military: { army: 38, airForce: 32, navy: 25, defenseSystems: 35, tech: 50, readiness: 42 },
    techLevel: 50,
    intelLevel: 52,
    strengths: ['نفت','قهوه'],
    weaknesses: ['امنیت'],
    economyPower: 48, militaryPower: 50,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    industrialProduction: 64,
    naturalResources: 37,
    resources: { oil: 40, gas: 35, minerals: 25, agriculture: 50, rare_earth: 13 },
    military: { army: 38, airForce: 32, navy: 25, defenseSystems: 35, tech: 65, readiness: 42 },
    techLevel: 65,
    intelLevel: 55,
    strengths: ['مس','لیتیم'],
    weaknesses: ['نابرابری'],
    economyPower: 65, militaryPower: 50,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    industrialProduction: 50,
    naturalResources: 45,
    resources: { oil: 50, gas: 40, minerals: 35, agriculture: 40, rare_earth: 10 },
    military: { army: 33, airForce: 27, navy: 20, defenseSystems: 30, tech: 50, readiness: 40 },
    techLevel: 50,
    intelLevel: 48,
    strengths: ['مس','طلا'],
    weaknesses: ['بی‌ثباتی سیاسی'],
    economyPower: 50, militaryPower: 45,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    color: '#10b981',
    region: 'آفریقا',
    description: 'بزرگ‌ترین اقتصاد آفریقا.',
    ...
    stability: 38,
    infrastructure: 42,
    industrialProduction: 34,
    naturalResources: 72,
    resources: { oil: 75, gas: 70, minerals: 60, agriculture: 30, rare_earth: 8 },
    military: { army: 33, airForce: 27, navy: 20, defenseSystems: 30, tech: 40, readiness: 40 },
    techLevel: 40,
    intelLevel: 42,
    strengths: ['نفت','جمعیت'],
    weaknesses: ['فساد','برق'],
    economyPower: 42, militaryPower: 45,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    industrialProduction: 47,
    naturalResources: 75,
    resources: { oil: 70, gas: 80, minerals: 55, agriculture: 30, rare_earth: 9 },
    military: { army: 43, airForce: 37, navy: 30, defenseSystems: 40, tech: 45, readiness: 47 },
    techLevel: 45,
    intelLevel: 50,
    strengths: ['گاز','نفت'],
    weaknesses: ['بیکاری جوانان'],
    economyPower: 48, militaryPower: 55,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    industrialProduction: 52,
    naturalResources: 27,
    resources: { oil: 25, gas: 30, minerals: 20, agriculture: 65, rare_earth: 10 },
    military: { army: 36, airForce: 30, navy: 23, defenseSystems: 33, tech: 50, readiness: 40 },
    techLevel: 50,
    intelLevel: 48,
    strengths: ['گردشگری','فسفات'],
    weaknesses: ['بیکاری'],
    economyPower: 50, militaryPower: 48,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    industrialProduction: 32,
    naturalResources: 25,
    resources: { oil: 20, gas: 20, minerals: 20, agriculture: 70, rare_earth: 7 },
    military: { army: 28, airForce: 22, navy: 15, defenseSystems: 25, tech: 35, readiness: 40 },
    techLevel: 35,
    intelLevel: 40,
    strengths: ['کشاورزی','نیروی کار'],
    weaknesses: ['درگیری','زیرساخت'],
    economyPower: 35, militaryPower: 40,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    industrialProduction: 47,
    naturalResources: 25,
    resources: { oil: 25, gas: 25, minerals: 20, agriculture: 65, rare_earth: 9 },
    military: { army: 30, airForce: 24, navy: 17, defenseSystems: 27, tech: 45, readiness: 40 },
    techLevel: 45,
    intelLevel: 45,
    strengths: ['فین‌تک','گردشگری'],
    weaknesses: ['بدهی'],
    economyPower: 45, militaryPower: 42,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    industrialProduction: 80,
    naturalResources: 25,
    resources: { oil: 20, gas: 25, minerals: 20, agriculture: 70, rare_earth: 16 },
    military: { army: 33, airForce: 27, navy: 20, defenseSystems: 30, tech: 80, readiness: 40 },
    techLevel: 80,
    intelLevel: 55,
    strengths: ['لبنیات','گردشگری'],
    weaknesses: ['فاصله جغرافیایی'],
    economyPower: 78, militaryPower: 45,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    color: '#ef4444',
    region: 'اروپا',
    description: 'صنعت خودرو اروپای مرکزی.',
    population: 9700000,
    baseGDP: 25,
    baseBudget: 9,
    debt: 40,
    ...
    industrialProduction: 64,
    naturalResources: 32,
    resources: { oil: 30, gas: 35, minerals: 20, agriculture: 60, rare_earth: 13 },
    military: { army: 36, airForce: 30, navy: 23, defenseSystems: 33, tech: 65, readiness: 40 },
    techLevel: 65,
    intelLevel: 50,
    strengths: ['خودرو','الکترونیک'],
    weaknesses: ['وابستگی خارجی'],
    economyPower: 58, militaryPower: 48,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    color: '#3b82f6',
    region: 'اروپا',
    description: 'کشاورزی و منابع با چالش جنگ.',
    population: 38000000,
    baseGDP: 20,
    baseBudget: 8,
    debt: 80,
    ...
    naturalResources: 32,
    resources: { oil: 30, gas: 35, minerals: 20, agriculture: 60, rare_earth: 10 },
    military: { army: 43, airForce: 37, navy: 30, defenseSystems: 40, tech: 50, readiness: 47 },
    techLevel: 50,
    intelLevel: 55,
    strengths: ['کشاورزی','معادن'],
    weaknesses: ['جنگ','فساد'],
    economyPower: 35, militaryPower: 55,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
  },
  {
    ...
    naturalResources: 25,
    resources: { oil: 20, gas: 25, minerals: 20, agriculture: 70, rare_earth: 18 },
    military: { army: 38, airForce: 32, navy: 25, defenseSystems: 35, tech: 90, readiness: 42 },
    techLevel: 90,
    intelLevel: 60,
    strengths: ['فناوری','آموزش'],
    weaknesses: ['بازار کوچک'],
    economyPower: 82, militaryPower: 50,
    startingChallenge: 'مدیریت چالش‌های ساختاری و رشد پایدار',
    economicOpportunities: ['توسعه زیرساخت', 'جذب سرمایه', 'صادرات']
...
const MAP_POSITIONS = {
  ...
  // V3 additional
  netherlands:  { top: 24, left: 46 },
  switzerland:  { top: 30, left: 48 },
  poland:       { top: 26, left: 52 },
  sweden:       { top: 16, left: 52 },
  belgium:      { top: 26, left: 45 },
  norway:       { top: 14, left: 50 },
  austria:      { top: 30, left: 50 },
  ireland:      { top: 24, left: 38 },
  portugal:     { top: 40, left: 38 },
  greece:       { top: 40, left: 54 },
  czech:        { top: 28, left: 50 },
  romania:      { top: 32, left: 55 },
  uae:          { top: 50, left: 62 },
  israel:       { top: 44, left: 56 },
  iran:         { top: 42, left: 64 },
  iraq:         { top: 44, left: 58 },
  qatar:        { top: 50, left: 62 },
  kuwait:       { top: 46, left: 60 },
  thailand:     { top: 52, left: 80 },
  vietnam:      { top: 50, left: 82 },
  malaysia:     { top: 58, left: 82 },
  philippines:  { top: 52, left: 88 },
  singapore:    { top: 60, left: 84 },
  pakistan:     { top: 42, left: 68 },
  bangladesh:   { top: 46, left: 74 },
  taiwan:       { top: 40, left: 86 },
  kazakhstan:   { top: 28, left: 66 },
  argentina:    { top: 78, left: 26 },
  colombia:     { top: 55, left: 20 },
  chile:        { top: 78, left: 22 },
  peru:         { top: 68, left: 20 },
  nigeria:      { top: 55, left: 46 },
  algeria:      { top: 45, left: 46 },
  morocco:      { top: 42, left: 40 },
  ethiopia:     { top: 55, left: 56 },
  kenya:        { top: 60, left: 56 },
  new_zealand:  { top: 85, left: 95 },
  hungary:      { top: 30, left: 52 },
